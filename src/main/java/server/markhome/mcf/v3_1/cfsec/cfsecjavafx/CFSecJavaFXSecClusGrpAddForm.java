// Description: Java 25 JavaFX Add Form implementation for SecClusGrp.
...
/**
 *	CFSecJavaFXSecClusGrpAddForm JavaFX Add Form implementation
 *	for SecClusGrp.
 */
public class CFSecJavaFXSecClusGrpAddForm
extends CFBorderPane
implements ICFSecJavaFXSecClusGrpPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Cluster Security Group";
	...
	public CFSecJavaFXSecClusGrpAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusGrpObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecClusGrpFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecClusGrpPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecClusGrpFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusGrpPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecClusGrpPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
