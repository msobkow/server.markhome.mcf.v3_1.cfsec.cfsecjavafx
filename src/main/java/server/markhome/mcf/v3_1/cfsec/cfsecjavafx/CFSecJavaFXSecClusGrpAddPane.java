// Description: Java 25 JavaFX Add Pane implementation for SecClusGrp.
...
/**
 *	CFSecJavaFXSecClusGrpAddPane JavaFX Add Pane implementation
 *	for SecClusGrp.
 */
public class CFSecJavaFXSecClusGrpAddPane
extends CFSplitPane
implements ICFSecJavaFXSecClusGrpPaneCommon
{
	...
	public CFSecJavaFXSecClusGrpAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusGrpObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusGrpPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
