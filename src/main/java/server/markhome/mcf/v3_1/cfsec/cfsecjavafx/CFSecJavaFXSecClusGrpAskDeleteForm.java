// Description: Java 25 JavaFX Ask Delete Pane implementation for SecClusGrp.
...
/**
 *	CFSecJavaFXSecClusGrpAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecClusGrp.
 */
public class CFSecJavaFXSecClusGrpAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecClusGrpPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Cluster Security Group";
	...
	public CFSecJavaFXSecClusGrpAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusGrpObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Cluster Security Group?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecClusGrpObj obj = getJavaFXFocusAsSecClusGrp();
					ICFSecSecClusGrpEditObj editObj = (ICFSecSecClusGrpEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecClusGrpFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecClusGrp( ICFSecSecClusGrpObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecClusGrpPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecClusGrpPaneCommon)attrPane).setPaneMode( value );
		}
	}
