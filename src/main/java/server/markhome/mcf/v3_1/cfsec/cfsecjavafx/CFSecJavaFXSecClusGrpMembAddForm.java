// Description: Java 25 JavaFX Add Form implementation for SecClusGrpMemb.
...
/**
 *	CFSecJavaFXSecClusGrpMembAddForm JavaFX Add Form implementation
 *	for SecClusGrpMemb.
 */
public class CFSecJavaFXSecClusGrpMembAddForm
extends CFBorderPane
implements ICFSecJavaFXSecClusGrpMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Cluster Security Group Member";
	...
	public CFSecJavaFXSecClusGrpMembAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusGrpMembObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecClusGrpMembFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecClusGrpMembPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecClusGrpMembFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusGrpMembPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecClusGrpMembPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
