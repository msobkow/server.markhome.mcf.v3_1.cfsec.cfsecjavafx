// Description: Java 25 JavaFX Add Pane implementation for SecClusGrpMemb.
...
/**
 *	CFSecJavaFXSecClusGrpMembAddPane JavaFX Add Pane implementation
 *	for SecClusGrpMemb.
 */
public class CFSecJavaFXSecClusGrpMembAddPane
extends CFSplitPane
implements ICFSecJavaFXSecClusGrpMembPaneCommon
{
	...
	public CFSecJavaFXSecClusGrpMembAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusGrpMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusGrpMembPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
