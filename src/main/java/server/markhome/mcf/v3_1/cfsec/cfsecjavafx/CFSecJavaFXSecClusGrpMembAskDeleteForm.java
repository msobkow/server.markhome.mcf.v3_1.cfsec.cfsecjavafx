// Description: Java 25 JavaFX Ask Delete Pane implementation for SecClusGrpMemb.
...
/**
 *	CFSecJavaFXSecClusGrpMembAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecClusGrpMemb.
 */
public class CFSecJavaFXSecClusGrpMembAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecClusGrpMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Cluster Security Group Member";
	...
	public CFSecJavaFXSecClusGrpMembAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusGrpMembObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Cluster Security Group Member?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecClusGrpMembObj obj = getJavaFXFocusAsSecClusGrpMemb();
					ICFSecSecClusGrpMembEditObj editObj = (ICFSecSecClusGrpMembEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecClusGrpMembFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecClusGrpMemb( ICFSecSecClusGrpMembObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecClusGrpMembPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecClusGrpMembPaneCommon)attrPane).setPaneMode( value );
		}
	}
