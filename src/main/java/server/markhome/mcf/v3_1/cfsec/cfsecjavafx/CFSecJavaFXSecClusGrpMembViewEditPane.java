// Description: Java 25 JavaFX View/Edit Pane implementation for SecClusGrpMemb.
...
/**
 *	CFSecJavaFXSecClusGrpMembViewEditPane JavaFX View/Edit Pane implementation
 *	for SecClusGrpMemb.
 */
public class CFSecJavaFXSecClusGrpMembViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecClusGrpMembPaneCommon
{
	...
	public CFSecJavaFXSecClusGrpMembViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusGrpMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusGrpMembPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
