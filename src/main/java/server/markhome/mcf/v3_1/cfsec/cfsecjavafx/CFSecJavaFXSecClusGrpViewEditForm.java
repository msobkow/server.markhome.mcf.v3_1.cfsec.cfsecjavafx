// Description: Java 25 JavaFX View/Edit Form implementation for SecClusGrp.
...
/**
 *	CFSecJavaFXSecClusGrpViewEditForm JavaFX View/Edit Form implementation
 *	for SecClusGrp.
 */
public class CFSecJavaFXSecClusGrpViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecClusGrpPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Cluster Security Group";
	...
	public CFSecJavaFXSecClusGrpViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusGrpObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecClusGrpObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSecClusGrpFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecClusGrpEditObj editObj = (ICFSecSecClusGrpEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecClusGrpPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecSecClusGrpObj argFocus = (ICFSecSecClusGrpObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecClusGrpObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecClusGrp() != null ) {
							if( null == getJavaFXFocusAsSecClusGrp().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSecClusGrp();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusGrpPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecClusGrpPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
