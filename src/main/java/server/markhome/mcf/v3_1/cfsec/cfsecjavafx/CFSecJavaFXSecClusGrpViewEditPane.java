// Description: Java 25 JavaFX View/Edit Pane implementation for SecClusGrp.
...
/**
 *	CFSecJavaFXSecClusGrpViewEditPane JavaFX View/Edit Pane implementation
 *	for SecClusGrp.
 */
public class CFSecJavaFXSecClusGrpViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecClusGrpPaneCommon
{
	...
	public CFSecJavaFXSecClusGrpViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusGrpObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getSecClusGrpFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusGrpPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecClusGrpPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFSecJavaFXSecClusGrpPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
