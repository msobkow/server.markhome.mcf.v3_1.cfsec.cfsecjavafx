// Description: Java 25 JavaFX Add Form implementation for SecClusRole.
...
/**
 *	CFSecJavaFXSecClusRoleAddForm JavaFX Add Form implementation
 *	for SecClusRole.
 */
public class CFSecJavaFXSecClusRoleAddForm
extends CFBorderPane
implements ICFSecJavaFXSecClusRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Cluster Security Role";
	...
	public CFSecJavaFXSecClusRoleAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusRoleObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecClusRoleFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecClusRolePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecClusRoleFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusRolePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecClusRolePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
