// Description: Java 25 JavaFX Add Pane implementation for SecClusRole.
...
/**
 *	CFSecJavaFXSecClusRoleAddPane JavaFX Add Pane implementation
 *	for SecClusRole.
 */
public class CFSecJavaFXSecClusRoleAddPane
extends CFSplitPane
implements ICFSecJavaFXSecClusRolePaneCommon
{
	...
	public CFSecJavaFXSecClusRoleAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusRoleObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusRolePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
