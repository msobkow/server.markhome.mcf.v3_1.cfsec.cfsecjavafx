// Description: Java 25 JavaFX Ask Delete Pane implementation for SecClusRole.
...
/**
 *	CFSecJavaFXSecClusRoleAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecClusRole.
 */
public class CFSecJavaFXSecClusRoleAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecClusRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Cluster Security Role";
	...
	public CFSecJavaFXSecClusRoleAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusRoleObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Cluster Security Role?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecClusRoleObj obj = getJavaFXFocusAsSecClusRole();
					ICFSecSecClusRoleEditObj editObj = (ICFSecSecClusRoleEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsSecClusRole( ICFSecSecClusRoleObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecClusRolePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
