// Description: Java 25 JavaFX Add Form implementation for SecClusRoleMemb.
...
/**
 *	CFSecJavaFXSecClusRoleMembAddForm JavaFX Add Form implementation
 *	for SecClusRoleMemb.
 */
public class CFSecJavaFXSecClusRoleMembAddForm
extends CFBorderPane
implements ICFSecJavaFXSecClusRoleMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Cluster Security Role Member";
	...
	public CFSecJavaFXSecClusRoleMembAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusRoleMembObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecClusRoleMembFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecClusRoleMembPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecClusRoleMembFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusRoleMembPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecClusRoleMembPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
