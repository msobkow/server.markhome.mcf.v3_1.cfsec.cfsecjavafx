// Description: Java 25 JavaFX Add Pane implementation for SecClusRoleMemb.
...
/**
 *	CFSecJavaFXSecClusRoleMembAddPane JavaFX Add Pane implementation
 *	for SecClusRoleMemb.
 */
public class CFSecJavaFXSecClusRoleMembAddPane
extends CFSplitPane
implements ICFSecJavaFXSecClusRoleMembPaneCommon
{
	...
	public CFSecJavaFXSecClusRoleMembAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusRoleMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusRoleMembPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
