// Description: Java 25 JavaFX Ask Delete Pane implementation for SecClusRoleMemb.
...
/**
 *	CFSecJavaFXSecClusRoleMembAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecClusRoleMemb.
 */
public class CFSecJavaFXSecClusRoleMembAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecClusRoleMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Cluster Security Role Member";
	...
	public CFSecJavaFXSecClusRoleMembAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusRoleMembObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Cluster Security Role Member?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecClusRoleMembObj obj = getJavaFXFocusAsSecClusRoleMemb();
					ICFSecSecClusRoleMembEditObj editObj = (ICFSecSecClusRoleMembEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecClusRoleMembFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecClusRoleMemb( ICFSecSecClusRoleMembObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecClusRoleMembPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecClusRoleMembPaneCommon)attrPane).setPaneMode( value );
		}
	}
