// Description: Java 25 JavaFX View/Edit Form implementation for SecClusRoleMemb.
...
/**
 *	CFSecJavaFXSecClusRoleMembViewEditForm JavaFX View/Edit Form implementation
 *	for SecClusRoleMemb.
 */
public class CFSecJavaFXSecClusRoleMembViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecClusRoleMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Cluster Security Role Member";
	...
	public CFSecJavaFXSecClusRoleMembViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusRoleMembObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecClusRoleMembObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSecClusRoleMembFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecClusRoleMembEditObj editObj = (ICFSecSecClusRoleMembEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecClusRoleMembPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecSecClusRoleMembObj argFocus = (ICFSecSecClusRoleMembObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecClusRoleMembObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecClusRoleMemb() != null ) {
							if( null == getJavaFXFocusAsSecClusRoleMemb().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSecClusRoleMemb();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusRoleMembPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecClusRoleMembPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
