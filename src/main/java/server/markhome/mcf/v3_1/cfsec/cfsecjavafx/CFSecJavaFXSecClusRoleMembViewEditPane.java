// Description: Java 25 JavaFX View/Edit Pane implementation for SecClusRoleMemb.
...
/**
 *	CFSecJavaFXSecClusRoleMembViewEditPane JavaFX View/Edit Pane implementation
 *	for SecClusRoleMemb.
 */
public class CFSecJavaFXSecClusRoleMembViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecClusRoleMembPaneCommon
{
	...
	public CFSecJavaFXSecClusRoleMembViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusRoleMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusRoleMembPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
