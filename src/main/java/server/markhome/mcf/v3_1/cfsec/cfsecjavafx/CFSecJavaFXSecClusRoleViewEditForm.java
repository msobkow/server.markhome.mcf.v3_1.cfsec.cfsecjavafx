// Description: Java 25 JavaFX View/Edit Form implementation for SecClusRole.
...
/**
 *	CFSecJavaFXSecClusRoleViewEditForm JavaFX View/Edit Form implementation
 *	for SecClusRole.
 */
public class CFSecJavaFXSecClusRoleViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecClusRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Cluster Security Role";
	...
	public CFSecJavaFXSecClusRoleViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecClusRoleObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecClusRoleObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSecClusRoleFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecClusRoleEditObj editObj = (ICFSecSecClusRoleEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecClusRolePaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecSecClusRoleObj argFocus = (ICFSecSecClusRoleObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecClusRoleObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecClusRole() != null ) {
							if( null == getJavaFXFocusAsSecClusRole().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSecClusRole();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecClusRolePaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecClusRolePaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
