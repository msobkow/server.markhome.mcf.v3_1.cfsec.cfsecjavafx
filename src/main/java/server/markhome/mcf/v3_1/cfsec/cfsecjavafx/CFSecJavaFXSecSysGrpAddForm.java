// Description: Java 25 JavaFX Add Form implementation for SecSysGrp.
...
/**
 *	CFSecJavaFXSecSysGrpAddForm JavaFX Add Form implementation
 *	for SecSysGrp.
 */
public class CFSecJavaFXSecSysGrpAddForm
extends CFBorderPane
implements ICFSecJavaFXSecSysGrpPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add System Security Group";
	...
	public CFSecJavaFXSecSysGrpAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecSysGrpObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxAddPane = argSchema.getSecSysGrpFactory().newAddPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecSysGrpEditObj editObj = (ICFSecSecSysGrpEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSysGrpPaneCommon)javafxAddPane).setJavaFXFocus( value );
		ICFSecSecSysGrpObj argFocus = (ICFSecSecSysGrpObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecSysGrpObj)argFocus.read( true );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						focus = getJavaFXFocusAsSecSysGrp();
						CFBorderPane frame = javafxSchema.getSecSysGrpFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysGrpPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecSysGrpPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
