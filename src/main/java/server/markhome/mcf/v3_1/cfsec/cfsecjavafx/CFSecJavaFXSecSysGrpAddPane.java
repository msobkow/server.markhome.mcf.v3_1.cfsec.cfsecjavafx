// Description: Java 25 JavaFX Add Pane implementation for SecSysGrp.
...
/**
 *	CFSecJavaFXSecSysGrpAddPane JavaFX Add Pane implementation
 *	for SecSysGrp.
 */
public class CFSecJavaFXSecSysGrpAddPane
extends CFSplitPane
implements ICFSecJavaFXSecSysGrpPaneCommon
{
	...
	public CFSecJavaFXSecSysGrpAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysGrpPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
