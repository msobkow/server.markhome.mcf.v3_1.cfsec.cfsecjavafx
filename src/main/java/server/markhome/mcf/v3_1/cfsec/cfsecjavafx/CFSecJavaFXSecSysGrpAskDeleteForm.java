// Description: Java 25 JavaFX Ask Delete Pane implementation for SecSysGrp.
...
/**
 *	CFSecJavaFXSecSysGrpAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecSysGrp.
 */
public class CFSecJavaFXSecSysGrpAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecSysGrpPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete System Security Group";
	...
	public CFSecJavaFXSecSysGrpAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this System Security Group?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecSysGrpObj obj = getJavaFXFocusAsSecSysGrp();
					ICFSecSecSysGrpEditObj editObj = (ICFSecSecSysGrpEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecSysGrpFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecSysGrp( ICFSecSecSysGrpObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecSysGrpPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecSysGrpPaneCommon)attrPane).setPaneMode( value );
		}
	}
