// Description: Java 25 JavaFX Add Form implementation for SecSysGrpInc.
...
/**
 *	CFSecJavaFXSecSysGrpIncAddForm JavaFX Add Form implementation
 *	for SecSysGrpInc.
 */
public class CFSecJavaFXSecSysGrpIncAddForm
extends CFBorderPane
implements ICFSecJavaFXSecSysGrpIncPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add System Security Group Include";
	...
	public CFSecJavaFXSecSysGrpIncAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpIncObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecSysGrpIncFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSysGrpIncPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecSysGrpIncFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysGrpIncPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecSysGrpIncPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
