// Description: Java 25 JavaFX Add Pane implementation for SecSysGrpInc.
...
/**
 *	CFSecJavaFXSecSysGrpIncAddPane JavaFX Add Pane implementation
 *	for SecSysGrpInc.
 */
public class CFSecJavaFXSecSysGrpIncAddPane
extends CFSplitPane
implements ICFSecJavaFXSecSysGrpIncPaneCommon
{
	...
	public CFSecJavaFXSecSysGrpIncAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpIncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysGrpIncPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
