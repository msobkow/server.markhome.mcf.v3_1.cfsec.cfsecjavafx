// Description: Java 25 JavaFX Ask Delete Pane implementation for SecSysGrpInc.
...
/**
 *	CFSecJavaFXSecSysGrpIncAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecSysGrpInc.
 */
public class CFSecJavaFXSecSysGrpIncAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecSysGrpIncPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete System Security Group Include";
	...
	public CFSecJavaFXSecSysGrpIncAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpIncObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this System Security Group Include?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecSysGrpIncObj obj = getJavaFXFocusAsSecSysGrpInc();
					ICFSecSecSysGrpIncEditObj editObj = (ICFSecSecSysGrpIncEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecSysGrpIncFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecSysGrpInc( ICFSecSecSysGrpIncObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecSysGrpIncPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecSysGrpIncPaneCommon)attrPane).setPaneMode( value );
		}
	}
