// Description: Java 25 JavaFX Picker Form implementation for SecSysGrpInc.
...
/**
 *	CFSecJavaFXSecSysGrpIncPickerForm JavaFX Picker Form implementation
 *	for SecSysGrpInc.
 */
public class CFSecJavaFXSecSysGrpIncPickerForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecSysGrpIncPickerForm( ICFFormManager formManager,
		...
		ICFSecJavaFXSecSysGrpIncChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getSecSysGrpIncFactory().newPickerPane( cfFormManager, argFocus, argContainer, argPageCallback, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSysGrpIncPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFSecSecSysGrpIncObj)value );
	}
	...
	public Collection<ICFSecSecSysGrpIncObj> getJavaFXDataCollection() {
		ICFSecJavaFXSecSysGrpIncPaneList jplPicker = (ICFSecJavaFXSecSysGrpIncPaneList)javafxPickerPane;
		Collection<ICFSecSecSysGrpIncObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFSecJavaFXSecSysGrpIncPaneCommon jpanelCommon = (ICFSecJavaFXSecSysGrpIncPaneCommon)javafxPickerPane;
