// Description: Java 25 JavaFX View/Edit Form implementation for SecSysGrpInc.
...
/**
 *	CFSecJavaFXSecSysGrpIncViewEditForm JavaFX View/Edit Form implementation
 *	for SecSysGrpInc.
 */
public class CFSecJavaFXSecSysGrpIncViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecSysGrpIncPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit System Security Group Include";
	...
	public CFSecJavaFXSecSysGrpIncViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpIncObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecSysGrpIncObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSecSysGrpIncFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecSysGrpIncEditObj editObj = (ICFSecSecSysGrpIncEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSysGrpIncPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecSecSysGrpIncObj argFocus = (ICFSecSecSysGrpIncObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecSysGrpIncObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecSysGrpInc() != null ) {
							if( null == getJavaFXFocusAsSecSysGrpInc().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSecSysGrpInc();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysGrpIncPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecSysGrpIncPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
