// Description: Java 25 JavaFX View/Edit Pane implementation for SecSysGrpInc.
...
/**
 *	CFSecJavaFXSecSysGrpIncViewEditPane JavaFX View/Edit Pane implementation
 *	for SecSysGrpInc.
 */
public class CFSecJavaFXSecSysGrpIncViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecSysGrpIncPaneCommon
{
	...
	public CFSecJavaFXSecSysGrpIncViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpIncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysGrpIncPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
