// Description: Java 25 JavaFX Add Form implementation for SecSysGrpMemb.
...
/**
 *	CFSecJavaFXSecSysGrpMembAddForm JavaFX Add Form implementation
 *	for SecSysGrpMemb.
 */
public class CFSecJavaFXSecSysGrpMembAddForm
extends CFBorderPane
implements ICFSecJavaFXSecSysGrpMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add System Security Group Member";
	...
	public CFSecJavaFXSecSysGrpMembAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpMembObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecSysGrpMembFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSysGrpMembPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecSysGrpMembFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysGrpMembPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecSysGrpMembPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
