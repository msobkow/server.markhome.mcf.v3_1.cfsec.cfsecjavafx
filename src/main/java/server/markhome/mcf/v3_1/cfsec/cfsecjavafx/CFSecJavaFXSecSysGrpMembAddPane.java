// Description: Java 25 JavaFX Add Pane implementation for SecSysGrpMemb.
...
/**
 *	CFSecJavaFXSecSysGrpMembAddPane JavaFX Add Pane implementation
 *	for SecSysGrpMemb.
 */
public class CFSecJavaFXSecSysGrpMembAddPane
extends CFSplitPane
implements ICFSecJavaFXSecSysGrpMembPaneCommon
{
	...
	public CFSecJavaFXSecSysGrpMembAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysGrpMembPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
