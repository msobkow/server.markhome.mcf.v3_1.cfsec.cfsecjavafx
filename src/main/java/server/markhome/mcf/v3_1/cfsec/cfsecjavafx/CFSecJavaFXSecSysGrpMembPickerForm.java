// Description: Java 25 JavaFX Picker Form implementation for SecSysGrpMemb.
...
/**
 *	CFSecJavaFXSecSysGrpMembPickerForm JavaFX Picker Form implementation
 *	for SecSysGrpMemb.
 */
public class CFSecJavaFXSecSysGrpMembPickerForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecSysGrpMembPickerForm( ICFFormManager formManager,
		...
		ICFSecJavaFXSecSysGrpMembChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getSecSysGrpMembFactory().newPickerPane( cfFormManager, argFocus, argContainer, argPageCallback, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSysGrpMembPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFSecSecSysGrpMembObj)value );
	}
	...
	public Collection<ICFSecSecSysGrpMembObj> getJavaFXDataCollection() {
		ICFSecJavaFXSecSysGrpMembPaneList jplPicker = (ICFSecJavaFXSecSysGrpMembPaneList)javafxPickerPane;
		Collection<ICFSecSecSysGrpMembObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFSecJavaFXSecSysGrpMembPaneCommon jpanelCommon = (ICFSecJavaFXSecSysGrpMembPaneCommon)javafxPickerPane;
