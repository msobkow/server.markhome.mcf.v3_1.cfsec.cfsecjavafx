// Description: Java 25 JavaFX View/Edit Form implementation for SecSysGrpMemb.
...
/**
 *	CFSecJavaFXSecSysGrpMembViewEditForm JavaFX View/Edit Form implementation
 *	for SecSysGrpMemb.
 */
public class CFSecJavaFXSecSysGrpMembViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecSysGrpMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit System Security Group Member";
	...
	public CFSecJavaFXSecSysGrpMembViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpMembObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecSysGrpMembObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSecSysGrpMembFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecSysGrpMembEditObj editObj = (ICFSecSecSysGrpMembEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSysGrpMembPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecSecSysGrpMembObj argFocus = (ICFSecSecSysGrpMembObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecSysGrpMembObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecSysGrpMemb() != null ) {
							if( null == getJavaFXFocusAsSecSysGrpMemb().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSecSysGrpMemb();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysGrpMembPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecSysGrpMembPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
