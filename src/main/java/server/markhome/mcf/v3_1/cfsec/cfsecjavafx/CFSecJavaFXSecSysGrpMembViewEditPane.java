// Description: Java 25 JavaFX View/Edit Pane implementation for SecSysGrpMemb.
...
/**
 *	CFSecJavaFXSecSysGrpMembViewEditPane JavaFX View/Edit Pane implementation
 *	for SecSysGrpMemb.
 */
public class CFSecJavaFXSecSysGrpMembViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecSysGrpMembPaneCommon
{
	...
	public CFSecJavaFXSecSysGrpMembViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysGrpMembPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
