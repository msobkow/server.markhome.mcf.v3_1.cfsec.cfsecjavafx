// Description: Java 25 JavaFX Picker Form implementation for SecSysGrp.
...
/**
 *	CFSecJavaFXSecSysGrpPickerForm JavaFX Picker Form implementation
 *	for SecSysGrp.
 */
public class CFSecJavaFXSecSysGrpPickerForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecSysGrpPickerForm( ICFFormManager formManager,
		...
		ICFSecJavaFXSecSysGrpChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getSecSysGrpFactory().newPickerPane( cfFormManager, argFocus, argContainer, argDataCollection, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSysGrpPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFSecSecSysGrpObj)value );
	}
	...
	public Collection<ICFSecSecSysGrpObj> getJavaFXDataCollection() {
		ICFSecJavaFXSecSysGrpPaneList jplPicker = (ICFSecJavaFXSecSysGrpPaneList)javafxPickerPane;
		Collection<ICFSecSecSysGrpObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFSecJavaFXSecSysGrpPaneCommon jpanelCommon = (ICFSecJavaFXSecSysGrpPaneCommon)javafxPickerPane;
