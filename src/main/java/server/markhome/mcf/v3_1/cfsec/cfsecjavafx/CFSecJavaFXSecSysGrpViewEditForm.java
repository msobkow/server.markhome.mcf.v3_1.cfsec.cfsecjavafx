// Description: Java 25 JavaFX View/Edit Form implementation for SecSysGrp.
...
/**
 *	CFSecJavaFXSecSysGrpViewEditForm JavaFX View/Edit Form implementation
 *	for SecSysGrp.
 */
public class CFSecJavaFXSecSysGrpViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecSysGrpPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit System Security Group";
	...
	public CFSecJavaFXSecSysGrpViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getSecSysGrpFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSysGrpPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecSysGrp() != null ) {
							if( null == getJavaFXFocusAsSecSysGrp().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysGrpPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecSysGrpPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
