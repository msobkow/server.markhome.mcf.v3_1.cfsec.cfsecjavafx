// Description: Java 25 JavaFX View/Edit Pane implementation for SecSysGrp.
...
/**
 *	CFSecJavaFXSecSysGrpViewEditPane JavaFX View/Edit Pane implementation
 *	for SecSysGrp.
 */
public class CFSecJavaFXSecSysGrpViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecSysGrpPaneCommon
{
	...
	public CFSecJavaFXSecSysGrpViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysGrpObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getSecSysGrpFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysGrpPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecSysGrpPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFSecJavaFXSecSysGrpPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
