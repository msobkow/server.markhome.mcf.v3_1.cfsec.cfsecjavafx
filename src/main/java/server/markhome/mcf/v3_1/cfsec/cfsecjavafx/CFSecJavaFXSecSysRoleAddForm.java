// Description: Java 25 JavaFX Add Form implementation for SecSysRole.
...
/**
 *	CFSecJavaFXSecSysRoleAddForm JavaFX Add Form implementation
 *	for SecSysRole.
 */
public class CFSecJavaFXSecSysRoleAddForm
extends CFBorderPane
implements ICFSecJavaFXSecSysRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security System Role";
	...
	public CFSecJavaFXSecSysRoleAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysRoleObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecSysRoleFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSysRolePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecSysRoleFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysRolePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecSysRolePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
