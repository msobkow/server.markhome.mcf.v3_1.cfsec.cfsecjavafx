// Description: Java 25 JavaFX Add Pane implementation for SecSysRole.
...
/**
 *	CFSecJavaFXSecSysRoleAddPane JavaFX Add Pane implementation
 *	for SecSysRole.
 */
public class CFSecJavaFXSecSysRoleAddPane
extends CFSplitPane
implements ICFSecJavaFXSecSysRolePaneCommon
{
	...
	public CFSecJavaFXSecSysRoleAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysRoleObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysRolePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
