// Description: Java 25 JavaFX Ask Delete Pane implementation for SecSysRole.
...
/**
 *	CFSecJavaFXSecSysRoleAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecSysRole.
 */
public class CFSecJavaFXSecSysRoleAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecSysRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security System Role";
	...
	public CFSecJavaFXSecSysRoleAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysRoleObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security System Role?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecSysRoleObj obj = getJavaFXFocusAsSecSysRole();
					ICFSecSecSysRoleEditObj editObj = (ICFSecSecSysRoleEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecSysRoleFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecSysRole( ICFSecSecSysRoleObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecSysRolePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecSysRolePaneCommon)attrPane).setPaneMode( value );
		}
	}
