// Description: Java 25 JavaFX Add Form implementation for SecSysRoleEnables.
...
/**
 *	CFSecJavaFXSecSysRoleEnablesAddForm JavaFX Add Form implementation
 *	for SecSysRoleEnables.
 */
public class CFSecJavaFXSecSysRoleEnablesAddForm
extends CFBorderPane
implements ICFSecJavaFXSecSysRoleEnablesPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security System Role Enables Group";
	...
	public CFSecJavaFXSecSysRoleEnablesAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysRoleEnablesObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecSysRoleEnablesObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxAddPane = argSchema.getSecSysRoleEnablesFactory().newAddPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecSysRoleEnablesEditObj editObj = (ICFSecSecSysRoleEnablesEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSysRoleEnablesPaneCommon)javafxAddPane).setJavaFXFocus( value );
		ICFSecSecSysRoleEnablesObj argFocus = (ICFSecSecSysRoleEnablesObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecSysRoleEnablesObj)argFocus.read( true );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						focus = getJavaFXFocusAsSecSysRoleEnables();
						CFBorderPane frame = javafxSchema.getSecSysRoleEnablesFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysRoleEnablesPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecSysRoleEnablesPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
