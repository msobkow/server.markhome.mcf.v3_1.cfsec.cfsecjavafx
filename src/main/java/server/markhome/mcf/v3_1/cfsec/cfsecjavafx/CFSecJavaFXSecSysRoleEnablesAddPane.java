// Description: Java 25 JavaFX Add Pane implementation for SecSysRoleEnables.
...
/**
 *	CFSecJavaFXSecSysRoleEnablesAddPane JavaFX Add Pane implementation
 *	for SecSysRoleEnables.
 */
public class CFSecJavaFXSecSysRoleEnablesAddPane
extends CFSplitPane
implements ICFSecJavaFXSecSysRoleEnablesPaneCommon
{
	...
	public CFSecJavaFXSecSysRoleEnablesAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysRoleEnablesObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysRoleEnablesPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
