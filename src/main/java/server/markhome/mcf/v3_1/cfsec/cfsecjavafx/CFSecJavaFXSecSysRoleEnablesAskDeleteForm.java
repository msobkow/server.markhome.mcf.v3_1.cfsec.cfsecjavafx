// Description: Java 25 JavaFX Ask Delete Pane implementation for SecSysRoleEnables.
...
/**
 *	CFSecJavaFXSecSysRoleEnablesAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecSysRoleEnables.
 */
public class CFSecJavaFXSecSysRoleEnablesAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecSysRoleEnablesPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security System Role Enables Group";
	...
	public CFSecJavaFXSecSysRoleEnablesAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysRoleEnablesObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security System Role Enables Group?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecSysRoleEnablesObj obj = getJavaFXFocusAsSecSysRoleEnables();
					ICFSecSecSysRoleEnablesEditObj editObj = (ICFSecSecSysRoleEnablesEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecSysRoleEnablesFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecSysRoleEnables( ICFSecSecSysRoleEnablesObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecSysRoleEnablesPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecSysRoleEnablesPaneCommon)attrPane).setPaneMode( value );
		}
	}
