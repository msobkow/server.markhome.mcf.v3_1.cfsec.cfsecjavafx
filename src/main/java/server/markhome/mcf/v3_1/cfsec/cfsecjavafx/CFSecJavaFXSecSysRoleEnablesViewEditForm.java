// Description: Java 25 JavaFX View/Edit Form implementation for SecSysRoleEnables.
...
/**
 *	CFSecJavaFXSecSysRoleEnablesViewEditForm JavaFX View/Edit Form implementation
 *	for SecSysRoleEnables.
 */
public class CFSecJavaFXSecSysRoleEnablesViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecSysRoleEnablesPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Security System Role Enables Group";
	...
	public CFSecJavaFXSecSysRoleEnablesViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysRoleEnablesObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getSecSysRoleEnablesFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSysRoleEnablesPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecSysRoleEnables() != null ) {
							if( null == getJavaFXFocusAsSecSysRoleEnables().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysRoleEnablesPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecSysRoleEnablesPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
