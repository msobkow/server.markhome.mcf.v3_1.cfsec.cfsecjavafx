// Description: Java 25 JavaFX View/Edit Pane implementation for SecSysRoleEnables.
...
/**
 *	CFSecJavaFXSecSysRoleEnablesViewEditPane JavaFX View/Edit Pane implementation
 *	for SecSysRoleEnables.
 */
public class CFSecJavaFXSecSysRoleEnablesViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecSysRoleEnablesPaneCommon
{
	...
	public CFSecJavaFXSecSysRoleEnablesViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysRoleEnablesObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysRoleEnablesPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
