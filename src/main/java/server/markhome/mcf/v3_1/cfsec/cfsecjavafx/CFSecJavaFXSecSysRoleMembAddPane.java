// Description: Java 25 JavaFX Add Pane implementation for SecSysRoleMemb.
...
/**
 *	CFSecJavaFXSecSysRoleMembAddPane JavaFX Add Pane implementation
 *	for SecSysRoleMemb.
 */
public class CFSecJavaFXSecSysRoleMembAddPane
extends CFSplitPane
implements ICFSecJavaFXSecSysRoleMembPaneCommon
{
	...
	public CFSecJavaFXSecSysRoleMembAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysRoleMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysRoleMembPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
