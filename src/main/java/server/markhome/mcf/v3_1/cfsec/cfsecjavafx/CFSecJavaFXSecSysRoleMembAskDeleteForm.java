// Description: Java 25 JavaFX Ask Delete Pane implementation for SecSysRoleMemb.
...
/**
 *	CFSecJavaFXSecSysRoleMembAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecSysRoleMemb.
 */
public class CFSecJavaFXSecSysRoleMembAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecSysRoleMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security System Role Member";
	...
	public CFSecJavaFXSecSysRoleMembAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysRoleMembObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security System Role Member?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecSysRoleMembObj obj = getJavaFXFocusAsSecSysRoleMemb();
					ICFSecSecSysRoleMembEditObj editObj = (ICFSecSecSysRoleMembEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecSysRoleMembFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecSysRoleMemb( ICFSecSecSysRoleMembObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecSysRoleMembPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecSysRoleMembPaneCommon)attrPane).setPaneMode( value );
		}
	}
