// Description: Java 25 JavaFX List of Obj Pane implementation for SecSysRoleMemb.
...
/**
 *	CFSecJavaFXSecSysRoleMembListPane JavaFX List of Obj Pane implementation
 *	for SecSysRoleMemb.
 */
public class CFSecJavaFXSecSysRoleMembListPane
extends CFBorderPane
implements ICFSecJavaFXSecSysRoleMembPaneList
{
	public static String S_FormName = "List Security System Role Member";
	...
	protected CFButton buttonAddSecSysRoleMemb = null;
	...
	public CFSecJavaFXSecSysRoleMembListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		...
		if( observableListOfSecSysRoleMemb != null ) {
	...
	public CFHBox getPanelHBoxMenu() {
		if( hboxMenu == null ) {
			...
			buttonAddSecSysRoleMemb = new CFButton();
			buttonAddSecSysRoleMemb.setMinWidth( 200 );
			buttonAddSecSysRoleMemb.setText( "Add Security System Role Member" );
			buttonAddSecSysRoleMemb.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					final String S_ProcName = "handle";
					try {
						ICFSecSchemaObj schemaObj = (ICFSecSchemaObj)javafxSchema.getSchema();
						ICFSecSecSysRoleMembObj obj = (ICFSecSecSysRoleMembObj)schemaObj.getSecSysRoleMembTableObj().newInstance();
						ICFSecSecSysRoleMembEditObj edit = (ICFSecSecSysRoleMembEditObj)( obj.beginEdit() );
						if( edit == null ) {
							throw new CFLibNullArgumentException( getClass(),
								S_ProcName,
								0,
						...
						CFBorderPane frame = javafxSchema.getSecSysRoleMembFactory().newAddForm( cfFormManager, obj, getViewEditClosedCallback(), true );
						ICFSecJavaFXSecSysRoleMembPaneCommon jpanelCommon = (ICFSecJavaFXSecSysRoleMembPaneCommon)frame;
			...
			hboxMenu.getChildren().add( buttonAddSecSysRoleMemb );
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFSec") && backingClassCode == ICFSecSecSysRoleMemb.CLASS_CODE ) {
								CFBorderPane frame = javafxSchema.getSecSysRoleMembFactory().newViewEditForm( cfFormManager, selectedInstance, getViewEditClosedCallback(), false );
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( entry.getSchemaName().equals("CFSec") && backingClassCode == ICFSecSecSysRoleMemb.CLASS_CODE ) {
								CFBorderPane frame = javafxSchema.getSecSysRoleMembFactory().newViewEditForm( cfFormManager, selectedInstance, getViewEditClosedCallback(), false );
								((ICFSecJavaFXSecSysRoleMembPaneCommon)frame).setPaneMode( CFPane.PaneMode.Edit );
								cfFormManager.pushForm( frame );
							}
							else {
								throw new CFLibUnsupportedClassException( getClass(),
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							int backingClassCode = entry.getBackingClassCode();
							if( entry.getSchemaName().equals("CFSec") && backingClassCode == ICFSecSecSysRoleMemb.CLASS_CODE ) {
								CFBorderPane frame = javafxSchema.getSecSysRoleMembFactory().newAskDeleteForm( cfFormManager, selectedInstance, getDeleteCallback() );
								((ICFSecJavaFXSecSysRoleMembPaneCommon)frame).setPaneMode( CFPane.PaneMode.View );
								cfFormManager.pushForm( frame );
							}
							else {
	...
	public void adjustListButtons() {
		...
		if( buttonAddSecSysRoleMemb != null ) {
			buttonAddSecSysRoleMemb.setDisable( ! allowAdds );
		}
