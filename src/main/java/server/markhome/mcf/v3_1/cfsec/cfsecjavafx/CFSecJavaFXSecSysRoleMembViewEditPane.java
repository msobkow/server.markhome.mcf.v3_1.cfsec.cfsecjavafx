// Description: Java 25 JavaFX View/Edit Pane implementation for SecSysRoleMemb.
...
/**
 *	CFSecJavaFXSecSysRoleMembViewEditPane JavaFX View/Edit Pane implementation
 *	for SecSysRoleMemb.
 */
public class CFSecJavaFXSecSysRoleMembViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecSysRoleMembPaneCommon
{
	...
	public CFSecJavaFXSecSysRoleMembViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysRoleMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysRoleMembPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
