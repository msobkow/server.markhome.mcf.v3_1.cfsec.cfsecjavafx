// Description: Java 25 JavaFX View/Edit Pane implementation for SecSysRole.
...
/**
 *	CFSecJavaFXSecSysRoleViewEditPane JavaFX View/Edit Pane implementation
 *	for SecSysRole.
 */
public class CFSecJavaFXSecSysRoleViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecSysRolePaneCommon
{
	...
	public CFSecJavaFXSecSysRoleViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSysRoleObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getSecSysRoleFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSysRolePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecSysRolePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFSecJavaFXSecSysRolePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
