// Description: Java 25 JavaFX Add Form implementation for SecTentGrp.
...
/**
 *	CFSecJavaFXSecTentGrpAddForm JavaFX Add Form implementation
 *	for SecTentGrp.
 */
public class CFSecJavaFXSecTentGrpAddForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecTentGrpAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecTentGrpFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecTentGrpPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecTentGrpFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentGrpPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecTentGrpPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
