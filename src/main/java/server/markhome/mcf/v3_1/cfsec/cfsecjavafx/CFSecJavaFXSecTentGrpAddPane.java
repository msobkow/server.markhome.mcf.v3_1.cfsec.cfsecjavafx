// Description: Java 25 JavaFX Add Pane implementation for SecTentGrp.
...
/**
 *	CFSecJavaFXSecTentGrpAddPane JavaFX Add Pane implementation
 *	for SecTentGrp.
 */
public class CFSecJavaFXSecTentGrpAddPane
extends CFSplitPane
implements ICFSecJavaFXSecTentGrpPaneCommon
{
	...
	public CFSecJavaFXSecTentGrpAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentGrpPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
