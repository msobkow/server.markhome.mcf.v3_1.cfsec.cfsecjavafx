// Description: Java 25 JavaFX Ask Delete Pane implementation for SecTentGrp.
...
/**
 *	CFSecJavaFXSecTentGrpAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecTentGrp.
 */
public class CFSecJavaFXSecTentGrpAskDeleteForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecTentGrpAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecTentGrpObj obj = getJavaFXFocusAsSecTentGrp();
					ICFSecSecTentGrpEditObj editObj = (ICFSecSecTentGrpEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsSecTentGrp( ICFSecSecTentGrpObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecTentGrpPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
