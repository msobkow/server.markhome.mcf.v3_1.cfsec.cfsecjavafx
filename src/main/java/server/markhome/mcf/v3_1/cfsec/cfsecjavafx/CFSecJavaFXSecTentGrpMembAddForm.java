// Description: Java 25 JavaFX Add Form implementation for SecTentGrpMemb.
...
/**
 *	CFSecJavaFXSecTentGrpMembAddForm JavaFX Add Form implementation
 *	for SecTentGrpMemb.
 */
public class CFSecJavaFXSecTentGrpMembAddForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecTentGrpMembAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpMembObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecTentGrpMembFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecTentGrpMembPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecTentGrpMembFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentGrpMembPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecTentGrpMembPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
