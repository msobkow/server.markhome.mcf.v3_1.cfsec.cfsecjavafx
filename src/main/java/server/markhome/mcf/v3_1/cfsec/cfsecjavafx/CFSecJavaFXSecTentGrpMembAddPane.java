// Description: Java 25 JavaFX Add Pane implementation for SecTentGrpMemb.
...
/**
 *	CFSecJavaFXSecTentGrpMembAddPane JavaFX Add Pane implementation
 *	for SecTentGrpMemb.
 */
public class CFSecJavaFXSecTentGrpMembAddPane
extends CFSplitPane
implements ICFSecJavaFXSecTentGrpMembPaneCommon
{
	...
	public CFSecJavaFXSecTentGrpMembAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentGrpMembPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
