// Description: Java 25 JavaFX Ask Delete Pane implementation for SecTentGrpMemb.
...
/**
 *	CFSecJavaFXSecTentGrpMembAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecTentGrpMemb.
 */
public class CFSecJavaFXSecTentGrpMembAskDeleteForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecTentGrpMembAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpMembObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecTentGrpMembObj obj = getJavaFXFocusAsSecTentGrpMemb();
					ICFSecSecTentGrpMembEditObj editObj = (ICFSecSecTentGrpMembEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecTentGrpMembFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecTentGrpMemb( ICFSecSecTentGrpMembObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecTentGrpMembPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecTentGrpMembPaneCommon)attrPane).setPaneMode( value );
		}
	}
