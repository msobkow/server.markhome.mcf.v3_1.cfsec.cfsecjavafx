// Description: Java 25 JavaFX View/Edit Form implementation for SecTentGrpMemb.
...
/**
 *	CFSecJavaFXSecTentGrpMembViewEditForm JavaFX View/Edit Form implementation
 *	for SecTentGrpMemb.
 */
public class CFSecJavaFXSecTentGrpMembViewEditForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecTentGrpMembViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpMembObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecTentGrpMembObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSecTentGrpMembFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecTentGrpMembEditObj editObj = (ICFSecSecTentGrpMembEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecTentGrpMembPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecSecTentGrpMembObj argFocus = (ICFSecSecTentGrpMembObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecTentGrpMembObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecTentGrpMemb() != null ) {
							if( null == getJavaFXFocusAsSecTentGrpMemb().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSecTentGrpMemb();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentGrpMembPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecTentGrpMembPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
