// Description: Java 25 JavaFX View/Edit Pane implementation for SecTentGrpMemb.
...
/**
 *	CFSecJavaFXSecTentGrpMembViewEditPane JavaFX View/Edit Pane implementation
 *	for SecTentGrpMemb.
 */
public class CFSecJavaFXSecTentGrpMembViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecTentGrpMembPaneCommon
{
	...
	public CFSecJavaFXSecTentGrpMembViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentGrpMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentGrpMembPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
