// Description: Java 25 JavaFX Add Form implementation for SecTentRole.
...
/**
 *	CFSecJavaFXSecTentRoleAddForm JavaFX Add Form implementation
 *	for SecTentRole.
 */
public class CFSecJavaFXSecTentRoleAddForm
extends CFBorderPane
implements ICFSecJavaFXSecTentRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Tenant Security Role";
	...
	public CFSecJavaFXSecTentRoleAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentRoleObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecTentRoleFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecTentRolePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecTentRoleFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentRolePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecTentRolePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
