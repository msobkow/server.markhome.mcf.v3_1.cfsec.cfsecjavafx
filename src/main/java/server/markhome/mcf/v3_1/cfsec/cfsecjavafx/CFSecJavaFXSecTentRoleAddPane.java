// Description: Java 25 JavaFX Add Pane implementation for SecTentRole.
...
/**
 *	CFSecJavaFXSecTentRoleAddPane JavaFX Add Pane implementation
 *	for SecTentRole.
 */
public class CFSecJavaFXSecTentRoleAddPane
extends CFSplitPane
implements ICFSecJavaFXSecTentRolePaneCommon
{
	...
	public CFSecJavaFXSecTentRoleAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentRoleObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentRolePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
