// Description: Java 25 JavaFX Ask Delete Pane implementation for SecTentRole.
...
/**
 *	CFSecJavaFXSecTentRoleAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecTentRole.
 */
public class CFSecJavaFXSecTentRoleAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecTentRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Tenant Security Role";
	...
	public CFSecJavaFXSecTentRoleAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentRoleObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Tenant Security Role?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecTentRoleObj obj = getJavaFXFocusAsSecTentRole();
					ICFSecSecTentRoleEditObj editObj = (ICFSecSecTentRoleEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecTentRoleFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecTentRole( ICFSecSecTentRoleObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecTentRolePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecTentRolePaneCommon)attrPane).setPaneMode( value );
		}
	}
