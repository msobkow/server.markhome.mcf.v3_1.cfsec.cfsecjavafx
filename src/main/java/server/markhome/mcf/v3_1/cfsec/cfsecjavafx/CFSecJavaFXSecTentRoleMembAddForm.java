// Description: Java 25 JavaFX Add Form implementation for SecTentRoleMemb.
...
/**
 *	CFSecJavaFXSecTentRoleMembAddForm JavaFX Add Form implementation
 *	for SecTentRoleMemb.
 */
public class CFSecJavaFXSecTentRoleMembAddForm
extends CFBorderPane
implements ICFSecJavaFXSecTentRoleMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Tenant Security Role Member";
	...
	public CFSecJavaFXSecTentRoleMembAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentRoleMembObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecTentRoleMembFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecTentRoleMembPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecTentRoleMembFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentRoleMembPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecTentRoleMembPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
