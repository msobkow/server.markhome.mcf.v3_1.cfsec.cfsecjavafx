// Description: Java 25 JavaFX Add Pane implementation for SecTentRoleMemb.
...
/**
 *	CFSecJavaFXSecTentRoleMembAddPane JavaFX Add Pane implementation
 *	for SecTentRoleMemb.
 */
public class CFSecJavaFXSecTentRoleMembAddPane
extends CFSplitPane
implements ICFSecJavaFXSecTentRoleMembPaneCommon
{
	...
	public CFSecJavaFXSecTentRoleMembAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentRoleMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentRoleMembPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
