// Description: Java 25 JavaFX Ask Delete Pane implementation for SecTentRoleMemb.
...
/**
 *	CFSecJavaFXSecTentRoleMembAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecTentRoleMemb.
 */
public class CFSecJavaFXSecTentRoleMembAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecTentRoleMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Tenant Security Role Member";
	...
	public CFSecJavaFXSecTentRoleMembAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentRoleMembObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Tenant Security Role Member?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecTentRoleMembObj obj = getJavaFXFocusAsSecTentRoleMemb();
					ICFSecSecTentRoleMembEditObj editObj = (ICFSecSecTentRoleMembEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecTentRoleMembFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecTentRoleMemb( ICFSecSecTentRoleMembObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecTentRoleMembPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecTentRoleMembPaneCommon)attrPane).setPaneMode( value );
		}
	}
