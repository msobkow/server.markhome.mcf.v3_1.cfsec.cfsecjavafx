// Description: Java 25 JavaFX Picker Form implementation for SecTentRoleMemb.
...
/**
 *	CFSecJavaFXSecTentRoleMembPickerForm JavaFX Picker Form implementation
 *	for SecTentRoleMemb.
 */
public class CFSecJavaFXSecTentRoleMembPickerForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecTentRoleMembPickerForm( ICFFormManager formManager,
		...
		ICFSecJavaFXSecTentRoleMembChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getSecTentRoleMembFactory().newPickerPane( cfFormManager, argFocus, argContainer, argPageCallback, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecTentRoleMembPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFSecSecTentRoleMembObj)value );
	}
	...
	public Collection<ICFSecSecTentRoleMembObj> getJavaFXDataCollection() {
		ICFSecJavaFXSecTentRoleMembPaneList jplPicker = (ICFSecJavaFXSecTentRoleMembPaneList)javafxPickerPane;
		Collection<ICFSecSecTentRoleMembObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFSecJavaFXSecTentRoleMembPaneCommon jpanelCommon = (ICFSecJavaFXSecTentRoleMembPaneCommon)javafxPickerPane;
	...
	public ICFSecSecTentRoleObj getJavaFXContainer() {
		ICFSecJavaFXSecTentRoleMembPaneList jplPicker = (ICFSecJavaFXSecTentRoleMembPaneList)javafxPickerPane;
		ICFSecSecTentRoleObj cnt = jplPicker.getJavaFXContainer();
		return( cnt );
	}
