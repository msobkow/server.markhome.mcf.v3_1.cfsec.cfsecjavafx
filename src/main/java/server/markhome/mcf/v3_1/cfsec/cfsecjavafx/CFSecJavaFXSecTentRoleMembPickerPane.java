// Description: Java 25 JavaFX Picker of Obj Pane implementation for SecTentRoleMemb.
...
/**
 *	CFSecJavaFXSecTentRoleMembPickerPane JavaFX Pick Obj Pane implementation
 *	for SecTentRoleMemb.
 */
public class CFSecJavaFXSecTentRoleMembPickerPane
extends CFBorderPane
implements ICFSecJavaFXSecTentRoleMembPaneList
{
	public static String S_FormName = "Choose Tenant Security Role Member";
	...
	protected ICFSecJavaFXSecTentRoleMembChosen invokeWhenChosen = null;
	protected ICFSecSecTentRoleObj javafxContainer = null;
	protected CFButton buttonCancel = null;
	protected CFButton buttonChooseNone = null;
	protected CFButton buttonChooseSelected = null;
	protected ScrollPane scrollMenu = null;
	public CFSecJavaFXSecTentRoleMembPickerPane( ICFFormManager formManager,
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSecTentRoleMemb( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseSecTentRoleMemb( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
