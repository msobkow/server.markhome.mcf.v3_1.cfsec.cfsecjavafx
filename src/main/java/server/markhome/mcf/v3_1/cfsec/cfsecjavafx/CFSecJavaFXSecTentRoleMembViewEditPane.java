// Description: Java 25 JavaFX View/Edit Pane implementation for SecTentRoleMemb.
...
/**
 *	CFSecJavaFXSecTentRoleMembViewEditPane JavaFX View/Edit Pane implementation
 *	for SecTentRoleMemb.
 */
public class CFSecJavaFXSecTentRoleMembViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecTentRoleMembPaneCommon
{
	...
	public CFSecJavaFXSecTentRoleMembViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentRoleMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentRoleMembPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
