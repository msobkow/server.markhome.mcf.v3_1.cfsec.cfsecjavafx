// Description: Java 25 JavaFX View/Edit Form implementation for SecTentRole.
...
/**
 *	CFSecJavaFXSecTentRoleViewEditForm JavaFX View/Edit Form implementation
 *	for SecTentRole.
 */
public class CFSecJavaFXSecTentRoleViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecTentRolePaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Tenant Security Role";
	...
	public CFSecJavaFXSecTentRoleViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentRoleObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecTentRoleObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSecTentRoleFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecTentRoleEditObj editObj = (ICFSecSecTentRoleEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecTentRolePaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecSecTentRoleObj argFocus = (ICFSecSecTentRoleObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecTentRoleObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecTentRole() != null ) {
							if( null == getJavaFXFocusAsSecTentRole().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSecTentRole();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentRolePaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecTentRolePaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
