// Description: Java 25 JavaFX View/Edit Pane implementation for SecTentRole.
...
/**
 *	CFSecJavaFXSecTentRoleViewEditPane JavaFX View/Edit Pane implementation
 *	for SecTentRole.
 */
public class CFSecJavaFXSecTentRoleViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecTentRolePaneCommon
{
	...
	public CFSecJavaFXSecTentRoleViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecTentRoleObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getSecTentRoleFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecTentRolePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecTentRolePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFSecJavaFXSecTentRolePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
