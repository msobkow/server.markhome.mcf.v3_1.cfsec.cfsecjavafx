// Description: Java 25 JavaFX Add Form implementation for SecUserEMConf.
...
/**
 *	CFSecJavaFXSecUserEMConfAddForm JavaFX Add Form implementation
 *	for SecUserEMConf.
 */
public class CFSecJavaFXSecUserEMConfAddForm
extends CFBorderPane
implements ICFSecJavaFXSecUserEMConfPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Email confirmation";
	...
	public CFSecJavaFXSecUserEMConfAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserEMConfObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecUserEMConfFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecUserEMConfPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecUserEMConfFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserEMConfPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecUserEMConfPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
