// Description: Java 25 JavaFX Ask Delete Pane implementation for SecUserEMConf.
...
/**
 *	CFSecJavaFXSecUserEMConfAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecUserEMConf.
 */
public class CFSecJavaFXSecUserEMConfAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecUserEMConfPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Email confirmation";
	...
	public CFSecJavaFXSecUserEMConfAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserEMConfObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Email confirmation?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecUserEMConfObj obj = getJavaFXFocusAsSecUserEMConf();
					ICFSecSecUserEMConfEditObj editObj = (ICFSecSecUserEMConfEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecUserEMConfFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecUserEMConf( ICFSecSecUserEMConfObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecUserEMConfPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecUserEMConfPaneCommon)attrPane).setPaneMode( value );
		}
	}
