// Description: Java 25 JavaFX View/Edit Pane implementation for SecUserEMConf.
...
/**
 *	CFSecJavaFXSecUserEMConfViewEditPane JavaFX View/Edit Pane implementation
 *	for SecUserEMConf.
 */
public class CFSecJavaFXSecUserEMConfViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecUserEMConfPaneCommon
{
	...
	public CFSecJavaFXSecUserEMConfViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserEMConfObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserEMConfPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
