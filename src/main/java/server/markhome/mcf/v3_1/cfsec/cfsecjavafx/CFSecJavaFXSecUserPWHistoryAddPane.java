// Description: Java 25 JavaFX Add Pane implementation for SecUserPWHistory.
...
/**
 *	CFSecJavaFXSecUserPWHistoryAddPane JavaFX Add Pane implementation
 *	for SecUserPWHistory.
 */
public class CFSecJavaFXSecUserPWHistoryAddPane
extends CFSplitPane
implements ICFSecJavaFXSecUserPWHistoryPaneCommon
{
	...
	public CFSecJavaFXSecUserPWHistoryAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPWHistoryObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPWHistoryPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
