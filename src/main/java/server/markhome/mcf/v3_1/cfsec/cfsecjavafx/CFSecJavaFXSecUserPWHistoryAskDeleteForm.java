// Description: Java 25 JavaFX Ask Delete Pane implementation for SecUserPWHistory.
...
/**
 *	CFSecJavaFXSecUserPWHistoryAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecUserPWHistory.
 */
public class CFSecJavaFXSecUserPWHistoryAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecUserPWHistoryPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security User Password History";
	...
	public CFSecJavaFXSecUserPWHistoryAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPWHistoryObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security User Password History?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecUserPWHistoryObj obj = getJavaFXFocusAsSecUserPWHistory();
					ICFSecSecUserPWHistoryEditObj editObj = (ICFSecSecUserPWHistoryEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecUserPWHistoryFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecUserPWHistory( ICFSecSecUserPWHistoryObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecUserPWHistoryPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecUserPWHistoryPaneCommon)attrPane).setPaneMode( value );
		}
	}
