// Description: Java 25 JavaFX View/Edit Form implementation for SecUserPWHistory.
...
/**
 *	CFSecJavaFXSecUserPWHistoryViewEditForm JavaFX View/Edit Form implementation
 *	for SecUserPWHistory.
 */
public class CFSecJavaFXSecUserPWHistoryViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecUserPWHistoryPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Security User Password History";
	...
	public CFSecJavaFXSecUserPWHistoryViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPWHistoryObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecUserPWHistoryObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSecUserPWHistoryFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecUserPWHistoryEditObj editObj = (ICFSecSecUserPWHistoryEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecUserPWHistoryPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecSecUserPWHistoryObj argFocus = (ICFSecSecUserPWHistoryObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecUserPWHistoryObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecUserPWHistory() != null ) {
							if( null == getJavaFXFocusAsSecUserPWHistory().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSecUserPWHistory();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPWHistoryPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecUserPWHistoryPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
