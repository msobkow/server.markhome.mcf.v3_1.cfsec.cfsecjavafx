// Description: Java 25 JavaFX View/Edit Pane implementation for SecUserPWHistory.
...
/**
 *	CFSecJavaFXSecUserPWHistoryViewEditPane JavaFX View/Edit Pane implementation
 *	for SecUserPWHistory.
 */
public class CFSecJavaFXSecUserPWHistoryViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecUserPWHistoryPaneCommon
{
	...
	public CFSecJavaFXSecUserPWHistoryViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPWHistoryObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPWHistoryPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
