// Description: Java 25 JavaFX Add Form implementation for SecUserPWReset.
...
/**
 *	CFSecJavaFXSecUserPWResetAddForm JavaFX Add Form implementation
 *	for SecUserPWReset.
 */
public class CFSecJavaFXSecUserPWResetAddForm
extends CFBorderPane
implements ICFSecJavaFXSecUserPWResetPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Password Reset";
	...
	public CFSecJavaFXSecUserPWResetAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPWResetObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecUserPWResetFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecUserPWResetPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecUserPWResetFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPWResetPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecUserPWResetPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
