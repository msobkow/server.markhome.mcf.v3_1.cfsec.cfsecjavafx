// Description: Java 25 JavaFX Add Pane implementation for SecUserPWReset.
...
/**
 *	CFSecJavaFXSecUserPWResetAddPane JavaFX Add Pane implementation
 *	for SecUserPWReset.
 */
public class CFSecJavaFXSecUserPWResetAddPane
extends CFSplitPane
implements ICFSecJavaFXSecUserPWResetPaneCommon
{
	...
	public CFSecJavaFXSecUserPWResetAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPWResetObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPWResetPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
