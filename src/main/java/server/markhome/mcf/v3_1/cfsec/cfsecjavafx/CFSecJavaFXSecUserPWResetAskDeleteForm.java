// Description: Java 25 JavaFX Ask Delete Pane implementation for SecUserPWReset.
...
/**
 *	CFSecJavaFXSecUserPWResetAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecUserPWReset.
 */
public class CFSecJavaFXSecUserPWResetAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecUserPWResetPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Password Reset";
	...
	public CFSecJavaFXSecUserPWResetAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPWResetObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Password Reset?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecUserPWResetObj obj = getJavaFXFocusAsSecUserPWReset();
					ICFSecSecUserPWResetEditObj editObj = (ICFSecSecUserPWResetEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecUserPWResetFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecUserPWReset( ICFSecSecUserPWResetObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecUserPWResetPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecUserPWResetPaneCommon)attrPane).setPaneMode( value );
		}
	}
