// Description: Java 25 JavaFX View/Edit Form implementation for SecUserPWReset.
...
/**
 *	CFSecJavaFXSecUserPWResetViewEditForm JavaFX View/Edit Form implementation
 *	for SecUserPWReset.
 */
public class CFSecJavaFXSecUserPWResetViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecUserPWResetPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Password Reset";
	...
	public CFSecJavaFXSecUserPWResetViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPWResetObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecUserPWResetObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSecUserPWResetFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecUserPWResetEditObj editObj = (ICFSecSecUserPWResetEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecUserPWResetPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecSecUserPWResetObj argFocus = (ICFSecSecUserPWResetObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecUserPWResetObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecUserPWReset() != null ) {
							if( null == getJavaFXFocusAsSecUserPWReset().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSecUserPWReset();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPWResetPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecUserPWResetPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
