// Description: Java 25 JavaFX View/Edit Pane implementation for SecUserPWReset.
...
/**
 *	CFSecJavaFXSecUserPWResetViewEditPane JavaFX View/Edit Pane implementation
 *	for SecUserPWReset.
 */
public class CFSecJavaFXSecUserPWResetViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecUserPWResetPaneCommon
{
	...
	public CFSecJavaFXSecUserPWResetViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPWResetObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPWResetPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
