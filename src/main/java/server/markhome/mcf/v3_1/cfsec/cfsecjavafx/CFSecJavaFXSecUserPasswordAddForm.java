// Description: Java 25 JavaFX Add Form implementation for SecUserPassword.
...
/**
 *	CFSecJavaFXSecUserPasswordAddForm JavaFX Add Form implementation
 *	for SecUserPassword.
 */
public class CFSecJavaFXSecUserPasswordAddForm
extends CFBorderPane
implements ICFSecJavaFXSecUserPasswordPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security User Password";
	...
	public CFSecJavaFXSecUserPasswordAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPasswordObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecUserPasswordFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecUserPasswordPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecUserPasswordFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPasswordPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecUserPasswordPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
