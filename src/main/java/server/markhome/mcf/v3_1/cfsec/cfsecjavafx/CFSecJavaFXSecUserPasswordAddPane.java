// Description: Java 25 JavaFX Add Pane implementation for SecUserPassword.
...
/**
 *	CFSecJavaFXSecUserPasswordAddPane JavaFX Add Pane implementation
 *	for SecUserPassword.
 */
public class CFSecJavaFXSecUserPasswordAddPane
extends CFSplitPane
implements ICFSecJavaFXSecUserPasswordPaneCommon
{
	...
	public CFSecJavaFXSecUserPasswordAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPasswordObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPasswordPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
