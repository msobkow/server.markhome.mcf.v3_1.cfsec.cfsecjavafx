// Description: Java 25 JavaFX Ask Delete Pane implementation for SecUserPassword.
...
/**
 *	CFSecJavaFXSecUserPasswordAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecUserPassword.
 */
public class CFSecJavaFXSecUserPasswordAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecUserPasswordPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security User Password";
	...
	public CFSecJavaFXSecUserPasswordAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPasswordObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security User Password?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecUserPasswordObj obj = getJavaFXFocusAsSecUserPassword();
					ICFSecSecUserPasswordEditObj editObj = (ICFSecSecUserPasswordEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecUserPasswordFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecUserPassword( ICFSecSecUserPasswordObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecUserPasswordPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecUserPasswordPaneCommon)attrPane).setPaneMode( value );
		}
	}
