// Description: Java 25 JavaFX View/Edit Form implementation for SecUserPassword.
...
/**
 *	CFSecJavaFXSecUserPasswordViewEditForm JavaFX View/Edit Form implementation
 *	for SecUserPassword.
 */
public class CFSecJavaFXSecUserPasswordViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecUserPasswordPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Security User Password";
	...
	public CFSecJavaFXSecUserPasswordViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPasswordObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecUserPasswordObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSecUserPasswordFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecUserPasswordEditObj editObj = (ICFSecSecUserPasswordEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecUserPasswordPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecSecUserPasswordObj argFocus = (ICFSecSecUserPasswordObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecUserPasswordObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecUserPassword() != null ) {
							if( null == getJavaFXFocusAsSecUserPassword().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSecUserPassword();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPasswordPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecUserPasswordPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
