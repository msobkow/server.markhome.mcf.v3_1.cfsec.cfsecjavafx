// Description: Java 25 JavaFX View/Edit Pane implementation for SecUserPassword.
...
/**
 *	CFSecJavaFXSecUserPasswordViewEditPane JavaFX View/Edit Pane implementation
 *	for SecUserPassword.
 */
public class CFSecJavaFXSecUserPasswordViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecUserPasswordPaneCommon
{
	...
	public CFSecJavaFXSecUserPasswordViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserPasswordObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPasswordPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
