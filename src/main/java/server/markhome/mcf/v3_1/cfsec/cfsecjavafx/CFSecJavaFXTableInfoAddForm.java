// Description: Java 25 JavaFX Add Form implementation for TableInfo.
...
/**
 *	CFSecJavaFXTableInfoAddForm JavaFX Add Form implementation
 *	for TableInfo.
 */
public class CFSecJavaFXTableInfoAddForm
extends CFBorderPane
implements ICFSecJavaFXTableInfoPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Table Information";
	...
	public CFSecJavaFXTableInfoAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTableInfoObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTableInfoFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXTableInfoPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTableInfoFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTableInfoPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXTableInfoPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
