// Description: Java 25 JavaFX Add Pane implementation for TableInfo.
...
/**
 *	CFSecJavaFXTableInfoAddPane JavaFX Add Pane implementation
 *	for TableInfo.
 */
public class CFSecJavaFXTableInfoAddPane
extends CFSplitPane
implements ICFSecJavaFXTableInfoPaneCommon
{
	...
	public CFSecJavaFXTableInfoAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTableInfoObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTableInfoPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
