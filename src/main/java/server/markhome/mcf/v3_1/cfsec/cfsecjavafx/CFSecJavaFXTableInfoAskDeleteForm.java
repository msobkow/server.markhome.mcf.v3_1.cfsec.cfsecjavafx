// Description: Java 25 JavaFX Ask Delete Pane implementation for TableInfo.
...
/**
 *	CFSecJavaFXTableInfoAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TableInfo.
 */
public class CFSecJavaFXTableInfoAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXTableInfoPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Table Information";
	...
	public CFSecJavaFXTableInfoAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTableInfoObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Table Information?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecTableInfoObj obj = getJavaFXFocusAsTableInfo();
					ICFSecTableInfoEditObj editObj = (ICFSecTableInfoEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getTableInfoFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsTableInfo( ICFSecTableInfoObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXTableInfoPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
