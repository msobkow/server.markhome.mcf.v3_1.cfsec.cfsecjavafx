// Description: Java 25 JavaFX Picker Form implementation for TableInfo.
...
/**
 *	CFSecJavaFXTableInfoPickerForm JavaFX Picker Form implementation
 *	for TableInfo.
 */
public class CFSecJavaFXTableInfoPickerForm
	...
	ICFForm
{
	...
	public CFSecJavaFXTableInfoPickerForm( ICFFormManager formManager,
		...
		ICFSecJavaFXTableInfoChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getTableInfoFactory().newPickerPane( cfFormManager, argFocus, argContainer, argDataCollection, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXTableInfoPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFSecTableInfoObj)value );
	}
	...
	public Collection<ICFSecTableInfoObj> getJavaFXDataCollection() {
		ICFSecJavaFXTableInfoPaneList jplPicker = (ICFSecJavaFXTableInfoPaneList)javafxPickerPane;
		Collection<ICFSecTableInfoObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFSecJavaFXTableInfoPaneCommon jpanelCommon = (ICFSecJavaFXTableInfoPaneCommon)javafxPickerPane;
