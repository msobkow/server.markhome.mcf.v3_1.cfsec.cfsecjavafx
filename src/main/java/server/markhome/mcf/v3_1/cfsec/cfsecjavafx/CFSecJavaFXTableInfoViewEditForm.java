// Description: Java 25 JavaFX View/Edit Form implementation for TableInfo.
...
/**
 *	CFSecJavaFXTableInfoViewEditForm JavaFX View/Edit Form implementation
 *	for TableInfo.
 */
public class CFSecJavaFXTableInfoViewEditForm
extends CFBorderPane
implements ICFSecJavaFXTableInfoPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Table Information";
	...
	public CFSecJavaFXTableInfoViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTableInfoObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecTableInfoObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getTableInfoFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecTableInfoEditObj editObj = (ICFSecTableInfoEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXTableInfoPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecTableInfoObj argFocus = (ICFSecTableInfoObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecTableInfoObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTableInfo() != null ) {
							if( null == getJavaFXFocusAsTableInfo().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsTableInfo();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTableInfoPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXTableInfoPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
